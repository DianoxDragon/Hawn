...
import fr.dianox.hawn.commands.*;
...
import fr.dianox.hawn.commands.features.chat.*;
import fr.dianox.hawn.commands.features.gamemode.*;
...
import fr.dianox.hawn.commands.features.warp.*;
import fr.dianox.hawn.commands.others.*;
...
import fr.dianox.hawn.utility.config.*;
import fr.dianox.hawn.utility.config.commands.*;
import fr.dianox.hawn.utility.config.cosmeticsfun.*;
...
import fr.dianox.hawn.utility.config.events.*;
import fr.dianox.hawn.utility.config.messages.*;
import fr.dianox.hawn.utility.config.messages.administration.*;
...
public class Main extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        fr.dianox.hawn.utility.config.messages.fr_fr.AdminPanelConfig.loadConfig(this);
        AdminSpawnMConfig.loadConfig(this);
        fr.dianox.hawn.utility.config.messages.fr_fr.ConfigMCommands.loadConfig(this);
        fr.dianox.hawn.utility.config.messages.fr_fr.ConfigMEvents.loadConfig(this);
        fr.dianox.hawn.utility.config.messages.fr_fr.ConfigMGeneral.loadConfig(this);
        fr.dianox.hawn.utility.config.messages.fr_fr.ConfigMOStuff.loadConfig(this);
        fr.dianox.hawn.utility.config.messages.fr_fr.ConfigMPlayerOption.loadConfig(this);
        fr.dianox.hawn.utility.config.messages.fr_fr.ConfigMProtection.loadConfig(this);
