...
public class ConfigMPlayerOption {
    ...
    private static void create() {
        if (!file.exists()) {
            ...
            Config.set("PlayerOption.Help.Enable", Boolean.valueOf(true));
            ...
            Config.set("PlayerOption.PlayerVisibility.ON.Enable", Boolean.valueOf(true));
            Config.set("PlayerOption.PlayerVisibility.ON.Messages", java.util.Arrays.asList(new String[] {"&aOh boy, the players are gone ?"}));
            Config.set("PlayerOption.PlayerVisibility.OFF.Enable", Boolean.valueOf(true));
            ...
            Config.set("PlayerOption.Error.Option-Disabled.Enable", Boolean.valueOf(true));
