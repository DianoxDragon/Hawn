...
public class FRWorldManagerPanelConfig {
    ...
    private static void create() {
        if (!file.exists()) {
             ...
             */
            // import
            Config.set("Gui.Import.Importing-A-World", java.util.Arrays.asList("[send-title]: &cImportation commencée //n &7Attendez, s'il vous plaît..."));
            ...
            Config.set("Gui.Create.World-Created", java.util.Arrays.asList("%prefix% &7Le monde &e%arg1% &7a été crée"));
            
            Config.set("Gui.Create.World-Cancelled", java.util.Arrays.asList("%prefix% &7Ne créer plus de monde désormais..."));
            
            // Delete
            Config.set("Gui.Delete.World-Deleted", java.util.Arrays.asList("%prefix% &cLe monde &e%arg1% &ca été supprimé"));
            
            Config.set("Gui.Delete.Error-Mystery", java.util.Arrays.asList("%prefix% &cQuelque chose d'étrange est arrivé... rien ne se passe, c'est une erreur, ignorez-la..."));
            
            // Modify World
            Config.set("Gui.Modify-World.Time-Changed", java.util.Arrays.asList("%prefix% &7L'heure du monde &e%arg1%&7 a été changé"));
            
            Config.set("Gui.Modify-World.Weather.Sun", java.util.Arrays.asList("%prefix% &7La météo pour le monde &e%arg1%&7 a été changé pour du soleil"));
            
            Config.set("Gui.Modify-World.Weather.Rain", java.util.Arrays.asList("%prefix% &7La météo pour le monde &e%arg1%&7 a été changé pour de la pluie"));
            
            Config.set("Gui.Modify-World.Weather.Storm", java.util.Arrays.asList("%prefix% &7La météo pour le monde &e%arg1%&7 a été changé pour une tempête"));
            
            // M. W. Dif.
            Config.set("Gui.Modify-World.Difficulty.Peaceful", java.util.Arrays.asList("%prefix% &7La difficulté pour le monde &e%arg1%&7 a été changé pour un mode paisible"));
            
            Config.set("Gui.Modify-World.Difficulty.Easy", java.util.Arrays.asList("%prefix% &7La difficulté pour le monde &e%arg1%&7 a été changé pour un mode facile"));
            
            Config.set("Gui.Modify-World.Difficulty.Normal", java.util.Arrays.asList("%prefix% &7La difficulté pour le monde &e%arg1%&7 a été changé pour un mode normal"));
            
            Config.set("Gui.Modify-World.Difficulty.Hard", java.util.Arrays.asList("%prefix% &7La difficulté pour le monde &e%arg1%&7 a été changé pour un mode difficile"));
             ...
             * Command
             */
            Config.set("Command.Unload.Error", java.util.Arrays.asList("%prefix% &cErreur, ce monde ne peux pas être déchargé"));
            Config.set("Command.Other.World", "Monde:");
            Config.set("Command.Other.Type", "Type:");
            
            Config.set("Error.NotGoodName", java.util.Arrays.asList("%prefix% &cErreur Hawn, le nom de monde avec un tel format de nom n'est pas autorisé",
		            "%prefix% &cLes seuls formats de noms autorisés sont : a-z | A-Z | 0-9 | _"));
            
            Config.set("Error.WorldNameNotTyped", java.util.Arrays.asList("%prefix% &cTu n'as pas tapé un nom de monde"));
            
            Config.set("Error.WorldCreation", java.util.Arrays.asList("%prefix% &cVous avez manqué quelque chose dans l'écriture de la commande..."));
            
            Config.set("Error.World-Already-Exist", java.util.Arrays.asList("%prefix% &cCe monde existe"));
