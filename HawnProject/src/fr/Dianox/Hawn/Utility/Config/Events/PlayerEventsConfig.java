...
public class PlayerEventsConfig {
    ...
    private static void create() {
        if (!file.exists()) {
            ...
            Config.set("Block-Mount.Enable", true);
            Config.set("Block-Mount.Bypass-With-Permission", false);
            Config.set("Block-Mount.World.All_World", false);
            Config.set("Block-Mount.World.Worlds", java.util.Arrays.asList(new String[] {
                    "world",
                    "world_nether"
            }));
